...
def main():
    ...
    if save_files:
        ...
        os.system(command)
        command = 'mkdir -p ' + networks_savepath + ' && cp nddepth_full_scale/networks/*.py ' + networks_savepath
        os.system(command)
        command = 'mkdir -p ' + dataloaders_savepath + ' && cp nddepth_full_scale/dataloaders/*.py ' + dataloaders_savepath
        os.system(command)
