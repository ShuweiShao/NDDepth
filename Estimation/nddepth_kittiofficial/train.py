...
from utils import post_process_depth, flip_lr, silog_loss, DN_to_distance, DN_to_depth, colormap, colormap_magma, colormap_viridis, compute_errors, compute_errors_kb, eval_metrics, \
...
def online_eval(model, dataloader_eval, gpu, ngpus, group, epoch, post_process=False):
    ...
    if not args.multiprocessing_distributed or gpu == 0:
        ...
        print("{:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}".format('silog', 
                                        'abs_rel', 'log10', 'rms', 'irms','sq_rel', 'log_rms', 'd1', 'd2','d3'))
        for i in range(9):
            ...
            if args.do_online_eval and global_step and global_step % args.eval_freq == 0 and not model_just_loaded:
                ...
                if eval_measures is not None:
                    ...
                    with open(log_txt, 'a') as txtfile:
                        ...
                        txtfile.write("{:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}, {:>7}\n".format('silog', 
                                        'abs_rel', 'log10', 'rms', 'irms','sq_rel', 'log_rms', 'd1', 'd2','d3'))
...
def main():
    ...
    if save_files:
        ...
        command = 'cp nddepth_kittiofficial/train.py ' + aux_out_path
        os.system(command)
        command = 'mkdir -p ' + networks_savepath + ' && cp nddepth_kittiofficial/networks/*.py ' + networks_savepath
        os.system(command)
        command = 'mkdir -p ' + dataloaders_savepath + ' && cp nddepth_kittiofficial/dataloaders/*.py ' + dataloaders_savepath
        os.system(command)
